      ...
      >
        <div className="bg-gray-800 bg-opacity-50 backdrop-blur-lg rounded-2xl overflow-hidden border border-gray-700 shadow-xl">
          ...
          <div className="p-6 text-center border-b border-gray-700">
            ...
            <p className="text-gray-400 mt-1">Join our AI image community</p>
          </div>
            ...
            <div className="space-y-5">
              ...
              >
                <input
                  id="terms"
                  type="checkbox"
                  className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-600 rounded bg-gray-700 bg-opacity-50"
                  required
                />
                <label
                  htmlFor="terms"
